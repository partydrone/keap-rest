    ...
    class Client
      module Campaigns
        ...
        def add_contacts_to_campaign_sequence(campaign_id, sequence_id)
          post("campaigns/#{campaign_id}/sequences/#{sequence_id}/contacts")
        end

        def delete_contacts_from_campaign_sequence(campaign_id, sequence_id)
          delete("campaigns/#{campaign_id}/sequences/#{sequence_id}/contacts")
        end
        ...
        def delete_contact_from_campaign_sequence(campaign_id, sequence_id, contact_id)
          delete("campaigns/#{campaign_id}/sequences/#{sequence_id}/contacts/#{contact_id}")
        end
